...
class CharacterChatBot():
    ...
    def chat(self, message, history):
        ...
        messages.append({"role":"system","content":""""You are Tyrion Lannister from the TV Show "Game of thrones". Your responses should reflect his personality and speech patterns \n"""})
